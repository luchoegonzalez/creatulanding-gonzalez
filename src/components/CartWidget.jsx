...
function CartWidget() {
  return (
    <>
      <div className="text-black hover:text-white hover:cursor-pointer rounded-xl p-2 hover:bg-pink-600 duration-150 relative">
        ...
        <span className='absolute -top-1 -right-1 rounded-full bg-pink-800 text-white size-6 flex items-center justify-center'>5</span>
      </div>
    </>
  )
}
